        ...
        <nav className="sticky top-0 z-50 w-full border-b border-violet-600/50 bg-white/60 backdrop-blur-xl transition-all duration-300">
            <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-4">
                    <Button
                        asChild
                        className="relative overflow-hidden rounded-full bg-violet-600 px-6 font-semibold text-white shadow-lg shadow-indigo-500/20 transition-all hover:scale-105 hover:bg-violet-700 hover:shadow-indigo-500/40 group"
                    >
