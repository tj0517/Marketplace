...
export default async function OfferPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="relative flex flex-col w-full min-h-screen bg-slate-50 overflow-x-hidden">
      ...
      <div className="w-full max-w-5xl mx-auto mt-4 sm:mt-10 px-4 sm:px-6">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-end gap-6 w-full">
              ...
              <div className="relative group border-0">
                ...
                <Avatar className="size-32 sm:size-40 ring-4 ring-white shadow-xl">
                  <AvatarFallback className="bg-purple-100 text-5xl font-black text-violet-600">{initials}</AvatarFallback>
                </Avatar>
                {/* Status dot */}
              ...
              <div className="flex-1 pb-2 sm:pl-6 w-full">
                <h1 className="text-3xl sm:text-5xl font-extrabold text-violet-600 tracking-tight drop-shadow-md mb-3">{ad.title}</h1>
              ...
              <div className="hidden lg:flex flex-col gap-3 shrink-0">
                <Button size="lg" className="bg-violet-500 text-white hover:bg-slate-50 font-bold transition-transform hover:scale-105 hover:bg-violet-600">
